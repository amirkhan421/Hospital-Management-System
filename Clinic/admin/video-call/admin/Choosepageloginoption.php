...
.container{
    ...
    backdrop-filter: blur(15px);
    border: 1px solid rgba(255, 255, 255, 0.1);
    margin-top: 20px; /* Added spacing from navbar */
}
...
@media(max-width: 768px){
    body {
        padding-top: 180px; /* Adjusted for stacked navbar */
    }
...
<nav class="top-navbar">
    ...
    <div class="nav-buttons">
        ...
        <a href="/Clinic/admin/video-call/admin/adminlogincall.php" class="nav-btn control">
            <i class="fas fa-user-shield"></i>
            <span>Control</span>
        </a>
        
       <a href="logoutcalladmin.php" class="nav-btn logout">
...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="card" id="patientCard">
            ...
            <button onclick="animateButton(this); setTimeout(() => location.href='show_awc.php', 1000);">
        ...
        <div class="card" id="doctorCard">
            ...
            <button onclick="animateButton(this); setTimeout(() => location.href='doctor_login_call.php', 1000);">
...
function animateWelcomeMessage() {
    ...
    animationInterval = setInterval(() => {
        welcomeMsg.querySelector('span').textContent = messages[index];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add time display in welcome message
    updateTime();
...
function updateTime() {
    ...
    const timeElement = document.querySelector('.time-display') || document.createElement('span');
    if (!timeElement.classList.contains('time-display')) {
        ...
        timeElement.style.cssText = `
            ...
            display: block;
        `;
        document.querySelector('.welcome-message').appendChild(timeElement);
    }
